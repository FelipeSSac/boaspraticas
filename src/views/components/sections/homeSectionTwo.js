import bg2 from '../../../assets/img/background/bg2.png'
import Vader from '../../../assets/img/elements/vader.png'
...
let HomeSectionTwo = `
<section class="section-background--two" style="background-image: url(${bg2})">
